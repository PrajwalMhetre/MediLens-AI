...
const badgeVariants = cva(
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        default: 'border-transparent bg-cyan-500/10 text-cyan-400 border-cyan-500/30',
        ...
        accent: 'border-transparent bg-purple-500/10 text-purple-400 border-purple-500/30',
      },
    },
    defaultVariants: {
      variant: 'default',
