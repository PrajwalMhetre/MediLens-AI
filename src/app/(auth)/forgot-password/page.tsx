        ...
        {submitted ? (
          <CardContent className="space-y-4 text-center py-6">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              If an account exists for <span className="text-cyan-400 font-semibold">{email}</span>, you will receive a secure password reset link within 2 minutes.
            </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <CardFooter className="flex flex-col space-y-4">
              ...
              <Link href="/login" className="text-xs text-center text-slate-400 hover:text-cyan-400 flex items-center justify-center gap-1">
