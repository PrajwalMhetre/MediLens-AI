...
export default function LoginPage() {
  ...
  const fillDemoCredentials = () => {
    ...
    toast.info('Demo credentials auto-filled. Use a real Supabase user for production.');
  };
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center px-4 py-12 relative selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      <Card className="w-full max-w-md border-slate-800 bg-slate-900/90 shadow-2xl relative z-10">
        <CardHeader className="text-center space-y-1">
          ...
          <CardDescription className="text-xs text-slate-400">Enter your credentials to access medical imaging workspace</CardDescription>
        </CardHeader>
        ...
        {authError && (
          <div className="mx-6 mb-2 rounded-lg border border-rose-500/30 bg-rose-500/10 px-3 py-2 text-xs text-rose-300">
            Email confirmation failed or the link is invalid. Please try again.
          </div>
        )}
