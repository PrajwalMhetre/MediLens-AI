...
class _ScanTabState extends State<ScanTab> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Corner bracket breathing
    _bracketController = AnimationController(
      vsync: this,
      duration: const Duration(milliseconds: 2500),
    )..repeat(reverse: true);

    _bracketAnimation = Tween<double>(begin: 0.0, end: 4.0).animate(
  ...
  void _triggerScanSimulation(BuildContext context) async {
    ...
    if (context.mounted) {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) =>
              MedicineDetailsScreen(medicine: scannedMed),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Simulated camera frame image background
          Positioned.fill(
            child: Opacity(
              opacity: 0.45,
              child:
                  Image.asset(AppAssets.onboardingScan, fit: BoxFit.cover),
            ),
          ),
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Stack(
                    children: [
                      ...
                      AnimatedBuilder(
                        animation: _bracketAnimation,
                        builder: (context, _) {
                          final offset = _bracketAnimation.value;
                          return Stack(
                            children: [
                              _buildCornerBracket(
                                top: 10 - offset,
                      ...
                      AnimatedBuilder(
                        ...
                        builder: (context, child) {
                          final topOffset =
                              _scannerPositionAnimation.value *
                                      (size.width * 0.75 - 20) +
                                  10;
                          return Positioned(
                            top: topOffset,
                ...
                Text(
                  ...
                  style:
                      AppStyles.bodyMd.copyWith(color: Colors.white70),
                ),
                const Spacer(),
