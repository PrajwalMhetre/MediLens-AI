...
class _ProfileTabState extends State<ProfileTab> {
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _buildStatCard("Blood Type", state.bloodType, Icons.bloodtype_rounded, Colors.red),
                  _buildStatCard("Weight", state.weight, Icons.scale_rounded, Colors.blue),
                ],
              ),
              const SizedBox(height: 16),
                    ...
                    _buildReportTile(
                      ...
                      () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text("PDF report downloaded to your device."),
  ...
  Widget _buildReportTile(String title, String subtitle, IconData icon, VoidCallback onTap) {
    return ListTile(
      ...
      title: Text(
        title,
        style: AppStyles.bodyLg.copyWith(fontWeight: FontWeight.w600, color: AppColors.onSurface),
      ),
      subtitle: Text(
        subtitle,
        style: AppStyles.bodyMd.copyWith(color: AppColors.onSurfaceVariant.withOpacity(0.7)),
      ),
  ...
  Widget _buildSwitchTile(String title, IconData icon, bool val, Function(bool) onChanged) {
